...
public class AddLiquidity extends DamlRecord<AddLiquidity> {
  ...
  public static JsonLfDecoder<AddLiquidity> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("provider", "tokenACid", "tokenBCid", "amountA", "amountB", "minLPTokens", "deadline"), name -> {
          switch (name) {
            ...
            case "tokenACid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(com.digitalasset.quickstart.codegen.token.token.Token.ContractId::new));
            case "tokenBCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(2, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(com.digitalasset.quickstart.codegen.token.token.Token.ContractId::new));
  ...
  public String toString() {
    return String.format("com.digitalasset.quickstart.codegen.amm.pool.AddLiquidity(%s, %s, %s, %s, %s, %s, %s)",
        this.provider, this.tokenACid, this.tokenBCid, this.amountA, this.amountB, this.minLPTokens,
        this.deadline);
  }
