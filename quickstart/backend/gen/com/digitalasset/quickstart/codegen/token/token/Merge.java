...
public class Merge extends DamlRecord<Merge> {
  ...
  public static JsonLfDecoder<Merge> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("otherTokenCid"), name -> {
          switch (name) {
            case "otherTokenCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(0, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(com.digitalasset.quickstart.codegen.token.token.Token.ContractId::new));
            default: return null;
          }
        }
  ...
  public String toString() {
    return String.format("com.digitalasset.quickstart.codegen.token.token.Merge(%s)",
        this.otherTokenCid);
  }
