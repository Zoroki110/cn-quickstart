package com.digitalasset.quickstart.codegen.amm.poolannouncement;
...
public final class PoolAnnouncement extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("#clearportx-amm-production", "AMM.PoolAnnouncement", "PoolAnnouncement");

  public static final Identifier TEMPLATE_ID_WITH_PACKAGE_ID = new Identifier("1de9ed0e61ea23f131fd098a50761ce6f6e377f1cf4012b5de6887adfed21637", "AMM.PoolAnnouncement", "PoolAnnouncement");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, PoolAnnouncement> COMPANION = 
      new ContractCompanion.WithoutKey<>(new ContractTypeCompanion.Package(PoolAnnouncement.PACKAGE_ID, PoolAnnouncement.PACKAGE_NAME, PoolAnnouncement.PACKAGE_VERSION),
        "com.digitalasset.quickstart.codegen.amm.poolannouncement.PoolAnnouncement", TEMPLATE_ID,
        ContractId::new, v -> PoolAnnouncement.templateValueDecoder().decode(v),
        PoolAnnouncement::fromJson, Contract::new, List.of(CHOICE_Archive));
  ...
  public static JsonLfDecoder<PoolAnnouncement> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("poolOperator", "poolId", "symbolA", "issuerA", "symbolB", "issuerB", "feeBps", "maxTTL", "createdAt"), name -> {
          switch (name) {
            ...
            case "maxTTL": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(7, new com.digitalasset.quickstart.codegen.da.time.types.RelTime.JsonDecoder$().get());
  ...
  public String toString() {
    return String.format("com.digitalasset.quickstart.codegen.amm.poolannouncement.PoolAnnouncement(%s, %s, %s, %s, %s, %s, %s, %s, %s)",
