...
public class RemoveLiquidity extends DamlRecord<RemoveLiquidity> {
  ...
  public static JsonLfDecoder<RemoveLiquidity> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("provider", "lpTokenCid", "lpTokenAmount", "minAmountA", "minAmountB", "deadline"), name -> {
          switch (name) {
            ...
            case "lpTokenCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(com.digitalasset.quickstart.codegen.lptoken.lptoken.LPToken.ContractId::new));
  ...
  public String toString() {
    return String.format("com.digitalasset.quickstart.codegen.amm.pool.RemoveLiquidity(%s, %s, %s, %s, %s, %s)",
        this.provider, this.lpTokenCid, this.lpTokenAmount, this.minAmountA, this.minAmountB,
        this.deadline);
  }
