package amm.atomicswap;

import static com.daml.ledger.javaapi.data.codegen.json.JsonLfEncoders.apply;

import amm.pool.Pool;
import amm.receipt.Receipt;
...
public final class AtomicSwapProposal extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("#clearportx-amm-drain-credit", "AMM.AtomicSwap", "AtomicSwapProposal");

  public static final Identifier TEMPLATE_ID_WITH_PACKAGE_ID = new Identifier("cdd2ef4c7b9ee84c219cb631e037555546b7c8dfdcea51f985c5c6ad41686f66", "AMM.AtomicSwap", "AtomicSwapProposal");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, AtomicSwapProposal> COMPANION = 
      new ContractCompanion.WithoutKey<>(new ContractTypeCompanion.Package(AtomicSwapProposal.PACKAGE_ID, AtomicSwapProposal.PACKAGE_NAME, AtomicSwapProposal.PACKAGE_VERSION),
        "amm.atomicswap.AtomicSwapProposal", TEMPLATE_ID, ContractId::new,
        v -> AtomicSwapProposal.templateValueDecoder().decode(v), AtomicSwapProposal::fromJson,
        Contract::new, List.of(CHOICE_ExecuteAtomicSwap, CHOICE_Archive));
  ...
  public static JsonLfDecoder<AtomicSwapProposal> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("trader", "poolCid", "poolParty", "poolOperator", "issuerA", "issuerB", "symbolA", "symbolB", "feeBps", "maxTTL", "protocolFeeReceiver", "traderInputTokenCid", "inputSymbol", "inputAmount", "outputSymbol", "minOutput", "maxPriceImpactBps", "deadline"), name -> {
          switch (name) {
            ...
            case "traderInputTokenCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(11, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(token.token.Token.ContractId::new));
  ...
  public String toString() {
    return String.format("amm.atomicswap.AtomicSwapProposal(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
