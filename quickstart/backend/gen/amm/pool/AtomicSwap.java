...
public class AtomicSwap extends DamlRecord<AtomicSwap> {
  ...
  public static JsonLfDecoder<AtomicSwap> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("trader", "traderInputTokenCid", "inputSymbol", "inputAmount", "outputSymbol", "minOutput", "maxPriceImpactBps", "deadline"), name -> {
          switch (name) {
            ...
            case "traderInputTokenCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(token.token.Token.ContractId::new));
  ...
  public String toString() {
    return String.format("amm.pool.AtomicSwap(%s, %s, %s, %s, %s, %s, %s, %s)", this.trader,
