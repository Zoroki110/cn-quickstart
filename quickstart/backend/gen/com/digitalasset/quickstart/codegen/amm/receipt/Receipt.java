package com.digitalasset.quickstart.codegen.amm.receipt;
...
public final class Receipt extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("#clearportx-amm-production", "AMM.Receipt", "Receipt");

  public static final Identifier TEMPLATE_ID_WITH_PACKAGE_ID = new Identifier("1de9ed0e61ea23f131fd098a50761ce6f6e377f1cf4012b5de6887adfed21637", "AMM.Receipt", "Receipt");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Receipt> COMPANION = 
      new ContractCompanion.WithoutKey<>(new ContractTypeCompanion.Package(Receipt.PACKAGE_ID, Receipt.PACKAGE_NAME, Receipt.PACKAGE_VERSION),
        "com.digitalasset.quickstart.codegen.amm.receipt.Receipt", TEMPLATE_ID, ContractId::new,
  ...
  public static JsonLfDecoder<Receipt> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("trader", "poolParty", "inputSymbol", "outputSymbol", "amountIn", "amountOut", "protocolFee", "price", "outputTokenCid", "newPoolCid", "timestamp"), name -> {
          switch (name) {
            ...
            case "outputTokenCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(8, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(com.digitalasset.quickstart.codegen.token.token.Token.ContractId::new));
            case "newPoolCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(9, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(com.digitalasset.quickstart.codegen.amm.pool.Pool.ContractId::new));
  ...
  public String toString() {
    return String.format("com.digitalasset.quickstart.codegen.amm.receipt.Receipt(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
