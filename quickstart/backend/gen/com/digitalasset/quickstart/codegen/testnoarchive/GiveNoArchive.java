...
public class GiveNoArchive extends DamlRecord<GiveNoArchive> {
  ...
  public GiveNoArchive(String newOwner) {
    this.newOwner = newOwner;
  }

  public static ValueDecoder<GiveNoArchive> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      Value recordValue$ = value$;
      List<com.daml.ledger.javaapi.data.DamlRecord.Field> fields$ = PrimitiveValueDecoders.recordCheck(1,0,
          recordValue$);
      String newOwner = PrimitiveValueDecoders.fromParty.decode(fields$.get(0).getValue());
      return new GiveNoArchive(newOwner);
    } ;
  }
  ...
  public static JsonLfDecoder<GiveNoArchive> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("newOwner"), name -> {
        ...
        , (Object[] args) -> new GiveNoArchive(JsonLfDecoders.cast(args[0])));
  }

  public static GiveNoArchive fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof GiveNoArchive)) {
      return false;
    }
    GiveNoArchive other = (GiveNoArchive) object;
  ...
  public String toString() {
    return String.format("com.digitalasset.quickstart.codegen.testnoarchive.GiveNoArchive(%s)",
        this.newOwner);
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<GiveNoArchive> get() {
      return jsonDecoder();
    }
  }
}
