...
public final class ProtocolFeeCollector extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("#clearportx-amm-drain-credit", "AMM.ProtocolFees", "ProtocolFeeCollector");

  public static final Identifier TEMPLATE_ID_WITH_PACKAGE_ID = new Identifier("cdd2ef4c7b9ee84c219cb631e037555546b7c8dfdcea51f985c5c6ad41686f66", "AMM.ProtocolFees", "ProtocolFeeCollector");
  ...
  public static final Choice<ProtocolFeeCollector, WithdrawProtocolFees, Tuple2<Token.ContractId, ContractId>> CHOICE_WithdrawProtocolFees = 
      Choice.create("WithdrawProtocolFees", value$ -> value$.toValue(), value$ ->
        ...
        Tuple2.<token.token.Token.ContractId,
        amm.protocolfees.ProtocolFeeCollector.ContractId>valueDecoder(v$0 ->
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, ProtocolFeeCollector> COMPANION = 
      new ContractCompanion.WithoutKey<>(new ContractTypeCompanion.Package(ProtocolFeeCollector.PACKAGE_ID, ProtocolFeeCollector.PACKAGE_NAME, ProtocolFeeCollector.PACKAGE_VERSION),
        "amm.protocolfees.ProtocolFeeCollector", TEMPLATE_ID, ContractId::new,
        v -> ProtocolFeeCollector.templateValueDecoder().decode(v), ProtocolFeeCollector::fromJson,
        Contract::new, List.of(CHOICE_AddProtocolFee, CHOICE_WithdrawProtocolFees, CHOICE_Archive,
        CHOICE_GetAccumulatedFees));
  ...
  public String toString() {
    return String.format("amm.protocolfees.ProtocolFeeCollector(%s, %s, %s, %s, %s, %s)",
