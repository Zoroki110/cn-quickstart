...
public final class SwapReady extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("#clearportx-amm-drain-credit", "AMM.SwapRequest", "SwapReady");

  public static final Identifier TEMPLATE_ID_WITH_PACKAGE_ID = new Identifier("cdd2ef4c7b9ee84c219cb631e037555546b7c8dfdcea51f985c5c6ad41686f66", "AMM.SwapRequest", "SwapReady");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, SwapReady> COMPANION = 
      new ContractCompanion.WithoutKey<>(new ContractTypeCompanion.Package(SwapReady.PACKAGE_ID, SwapReady.PACKAGE_NAME, SwapReady.PACKAGE_VERSION),
        "amm.swaprequest.SwapReady", TEMPLATE_ID, ContractId::new,
        v -> SwapReady.templateValueDecoder().decode(v), SwapReady::fromJson, Contract::new,
        List.of(CHOICE_Archive, CHOICE_ExecuteSwap));
  ...
  public static JsonLfDecoder<SwapReady> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("trader", "poolCid", "poolParty", "protocolFeeReceiver", "issuerA", "issuerB", "symbolA", "symbolB", "feeBps", "maxTTL", "inputSymbol", "inputAmount", "poolInputCid", "outputSymbol", "minOutput", "deadline", "maxPriceImpactBps", "protocolFeeAmount"), name -> {
          switch (name) {
            ...
            case "poolInputCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(12, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(token.token.Token.ContractId::new));
  ...
  public String toString() {
    return String.format("amm.swaprequest.SwapReady(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
