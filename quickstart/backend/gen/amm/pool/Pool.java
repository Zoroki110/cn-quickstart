...
public final class Pool extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("#clearportx-amm-drain-credit", "AMM.Pool", "Pool");

  public static final Identifier TEMPLATE_ID_WITH_PACKAGE_ID = new Identifier("cdd2ef4c7b9ee84c219cb631e037555546b7c8dfdcea51f985c5c6ad41686f66", "AMM.Pool", "Pool");
  ...
  public static final Choice<Pool, AtomicSwap, Tuple2<Token.ContractId, ContractId>> CHOICE_AtomicSwap = 
      Choice.create("AtomicSwap", value$ -> value$.toValue(), value$ -> AtomicSwap.valueDecoder()
        .decode(value$), value$ -> Tuple2.<token.token.Token.ContractId,
        amm.pool.Pool.ContractId>valueDecoder(v$0 ->
  ...
  public static final Choice<Pool, AddLiquidity, Tuple2<LPToken.ContractId, ContractId>> CHOICE_AddLiquidity = 
      Choice.create("AddLiquidity", value$ -> value$.toValue(), value$ ->
        ...
        Tuple2.<lptoken.lptoken.LPToken.ContractId, amm.pool.Pool.ContractId>valueDecoder(v$0 ->
  ...
  public static final Choice<Pool, RemoveLiquidity, Tuple3<Token.ContractId, Token.ContractId, ContractId>> CHOICE_RemoveLiquidity = 
      Choice.create("RemoveLiquidity", value$ -> value$.toValue(), value$ ->
        ...
        Tuple3.<token.token.Token.ContractId, token.token.Token.ContractId,
        amm.pool.Pool.ContractId>valueDecoder(v$0 ->
          new Token.ContractId(v$0.asContractId().orElseThrow(() -> new IllegalArgumentException("Expected value$ to be of type com.daml.ledger.javaapi.data.ContractId")).getValue()),
        v$1 ->
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Pool> COMPANION = 
      new ContractCompanion.WithoutKey<>(new ContractTypeCompanion.Package(Pool.PACKAGE_ID, Pool.PACKAGE_NAME, Pool.PACKAGE_VERSION),
        "amm.pool.Pool", TEMPLATE_ID, ContractId::new, v -> Pool.templateValueDecoder().decode(v),
        Pool::fromJson, Contract::new, List.of(CHOICE_GetSpotPrice, CHOICE_VerifyReserves,
        CHOICE_RemoveLiquidity, CHOICE_GetReservesForPool, CHOICE_GrantVisibility,
        CHOICE_AtomicSwap, CHOICE_Archive, CHOICE_AddLiquidity, CHOICE_GetSupply,
        CHOICE_ArchiveAndUpdateReserves));
  ...
  public final List<String> extraObservers;
  ...
  public Pool(String poolOperator, String poolParty, String lpIssuer, String issuerA,
      ...
      String protocolFeeReceiver, Long maxInBps, Long maxOutBps, List<String> extraObservers) {
   ...
   */
  @Deprecated
  public Update<Exercised<ContractId>> createAndExerciseGrantVisibility(String newObserver) {
    return createAndExerciseGrantVisibility(new GrantVisibility(newObserver));
  }
  ...
  public static Update<Created<ContractId>> create(String poolOperator, String poolParty,
      ...
      Long maxOutBps, List<String> extraObservers) {
    return new Pool(poolOperator, poolParty, lpIssuer, issuerA, issuerB, symbolA, symbolB, feeBps,
        ...
        protocolFeeReceiver, maxInBps, maxOutBps, extraObservers).create();
  }
  ...
  public DamlRecord toValue() {
    ...
    fields.add(new DamlRecord.Field("extraObservers", this.extraObservers.stream().collect(DamlCollectors.toDamlList(v$0 -> new Party(v$0)))));
  ...
  private static ValueDecoder<Pool> templateValueDecoder() throws IllegalArgumentException {
    return value$ -> {
      ...
      List<String> extraObservers = PrimitiveValueDecoders.fromList(
            PrimitiveValueDecoders.fromParty).decode(fields$.get(18).getValue());
      return new Pool(poolOperator, poolParty, lpIssuer, issuerA, issuerB, symbolA, symbolB, feeBps,
          poolId, maxTTL, totalLPSupply, reserveA, reserveB, tokenACid, tokenBCid,
          protocolFeeReceiver, maxInBps, maxOutBps, extraObservers);
    } ;
  }

  public static JsonLfDecoder<Pool> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("poolOperator", "poolParty", "lpIssuer", "issuerA", "issuerB", "symbolA", "symbolB", "feeBps", "poolId", "maxTTL", "totalLPSupply", "reserveA", "reserveB", "tokenACid", "tokenBCid", "protocolFeeReceiver", "maxInBps", "maxOutBps", "extraObservers"), name -> {
          switch (name) {
            ...
            case "maxTTL": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(9, new da.time.types.RelTime.JsonDecoder$().get());
            ...
            case "tokenACid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(13, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.optional(com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(token.token.Token.ContractId::new)), java.util.Optional.empty());
            case "tokenBCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(14, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.optional(com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(token.token.Token.ContractId::new)), java.util.Optional.empty());
            ...
            case "extraObservers": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(18, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.list(com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.party));
            default: return null;
          }
        }
  ...
  public JsonLfEncoder jsonEncoder() {
    return JsonLfEncoders.record(
        ...
        JsonLfEncoders.Field.of("extraObservers", apply(JsonLfEncoders.list(JsonLfEncoders::party), extraObservers)));
  }
  ...
  public boolean equals(Object object) {
    ...
    return Objects.equals(this.poolOperator, other.poolOperator) &&
        ...
        Objects.equals(this.extraObservers, other.extraObservers);
  }
  ...
  public int hashCode() {
    return Objects.hash(this.poolOperator, this.poolParty, this.lpIssuer, this.issuerA,
        ...
        this.protocolFeeReceiver, this.maxInBps, this.maxOutBps, this.extraObservers);
  }

  @Override
  public String toString() {
    return String.format("amm.pool.Pool(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        this.maxOutBps, this.extraObservers);
  }
  ...
  public interface Exercises<Cmd> extends com.daml.ledger.javaapi.data.codegen.Exercises.Archivable<Cmd> {
    ...
    default Update<Exercised<ContractId>> exerciseGrantVisibility(String newObserver) {
      return exerciseGrantVisibility(new GrantVisibility(newObserver));
    }
