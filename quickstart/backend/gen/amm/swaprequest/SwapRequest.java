...
public final class SwapRequest extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("#clearportx-amm-drain-credit", "AMM.SwapRequest", "SwapRequest");

  public static final Identifier TEMPLATE_ID_WITH_PACKAGE_ID = new Identifier("cdd2ef4c7b9ee84c219cb631e037555546b7c8dfdcea51f985c5c6ad41686f66", "AMM.SwapRequest", "SwapRequest");
  ...
  public static final Choice<SwapRequest, PrepareSwap, Tuple2<SwapReady.ContractId, Token.ContractId>> CHOICE_PrepareSwap = 
      Choice.create("PrepareSwap", value$ -> value$.toValue(), value$ -> PrepareSwap.valueDecoder()
        .decode(value$), value$ -> Tuple2.<amm.swaprequest.SwapReady.ContractId,
        token.token.Token.ContractId>valueDecoder(v$0 ->
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, SwapRequest> COMPANION = 
      new ContractCompanion.WithoutKey<>(new ContractTypeCompanion.Package(SwapRequest.PACKAGE_ID, SwapRequest.PACKAGE_NAME, SwapRequest.PACKAGE_VERSION),
        "amm.swaprequest.SwapRequest", TEMPLATE_ID, ContractId::new,
        v -> SwapRequest.templateValueDecoder().decode(v), SwapRequest::fromJson, Contract::new,
        List.of(CHOICE_CancelSwapRequest, CHOICE_PrepareSwap, CHOICE_Archive));
  ...
  public static JsonLfDecoder<SwapRequest> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("trader", "poolCid", "poolParty", "poolOperator", "issuerA", "issuerB", "symbolA", "symbolB", "feeBps", "maxTTL", "inputTokenCid", "inputSymbol", "inputAmount", "outputSymbol", "minOutput", "deadline", "maxPriceImpactBps"), name -> {
          switch (name) {
            ...
            case "poolCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(1, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(amm.pool.Pool.ContractId::new));
            ...
            case "inputTokenCid": return com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.JavaArg.at(10, com.daml.ledger.javaapi.data.codegen.json.JsonLfDecoders.contractId(token.token.Token.ContractId::new));
  ...
  public String toString() {
    return String.format("amm.swaprequest.SwapRequest(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
